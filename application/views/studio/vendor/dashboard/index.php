						...
						<div class="card-img-overlay d-none d-md-block bottom-0 top-auto">
							<div class="row">
								...
								<div class="col-md-4 col-xl-6 mb-n2">
									<img src="assets/img/page/dashboard.svg" class="d-block ml-n3 mb-5" style="max-height: 310px" />
								</div>
							</div>
						</div>
						<!-- END card-img-overlay -->
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 202px;">
								<!-- BEGIN card-img-overlay -->
								<div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
									<img src="assets/img/icon/visitor.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
								</div>
								<!-- END card-img-overlay -->
						...
						<div class="col-sm-6">
							...
							<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink" style="min-height: 202px;">
								<!-- BEGIN card-img-overlay -->
								<div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
									<img src="<?php echo base_url(); ?>assets/studio/img/icon/email.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
								</div>
								<!-- END card-img-overlay -->
							...
							<div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
								<!-- BEGIN card-img-overlay -->
								<div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
									<img src="<?php echo base_url(); ?>assets/studio/img/icon/browser.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
								</div>
								<!-- end card-img-overlay -->
									...
									<div class="fs-13px">
										<div class="d-flex align-items-center mb-2">
											<div class="flex-grow-1 d-flex align-items-center">
												<i class="fa fa-circle fs-9px fa-fw text-primary mr-2"></i> Direct visit
											</div>
											<div class="font-weight-600 text-dark">42.66%</div>
										</div>
										<div class="d-flex align-items-center mb-2">
											<div class="flex-grow-1 d-flex align-items-center">
												<i class="fa fa-circle fs-9px fa-fw text-teal mr-2"></i> Organic Search
											</div>
											<div class="font-weight-600 text-dark">36.80%</div>
										</div>
										<div class="d-flex align-items-center mb-2">
											<div class="flex-grow-1 d-flex align-items-center">
												<i class="fa fa-circle fs-9px fa-fw text-warning mr-2"></i> Referral Website
											</div>
											<div class="font-weight-600 text-dark">15.34%</div>
										</div>
										<div class="d-flex align-items-center mb-2">
											<div class="flex-grow-1 d-flex align-items-center">
												<i class="fa fa-circle fs-9px fa-fw text-danger mr-2"></i> Social Networks
											</div>
						...
						<div class="card-body">
							...
							<div class="d-flex align-items-center mb-3">
								<div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
									<img src="<?php echo base_url(); ?>assets/studio/img/product/product-1.jpg" alt="" class="mw-100 mh-100" />
								</div>
								<div class="flex-grow-1">
									<div>
							...
							<div class="d-flex align-items-center mb-3">
								<div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
									<img src="<?php echo base_url(); ?>assets/studio/img/product/product-2.jpg" alt="" class="mw-100 mh-100" />
								</div>
								<div class="flex-grow-1">
									<div>
							...
							<div class="d-flex align-items-center mb-3">
								<div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
									<img src="<?php echo base_url(); ?>assets/studio/img/product/product-3.jpg" alt="" class="mw-100 mh-100" />
								</div>
								<div class="flex-grow-1">
									<div>
							...
							<div class="d-flex align-items-center mb-3">
								<div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
									<img src="<?php echo base_url(); ?>assets/studio/img/product/product-4.jpg" alt="" class="mw-100 mh-100" />
								</div>
								<div class="flex-grow-1">
									<div>
							...
							<div class="d-flex align-items-center">
								<div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
									<img src="<?php echo base_url(); ?>assets/studio/img/product/product-5.jpg" alt="" class="mw-100 mh-100" />
								</div>
								<div class="flex-grow-1">
									<div>
									...
									<tbody>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="width-40 height-40">
														<img src="<?php echo base_url(); ?>assets/studio/img/icon/paypal2.svg" class="mw-100 mh-100" />
													</div>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="width-40 height-40 rounded">
														<img src="<?php echo base_url(); ?>assets/studio/img/icon/mastercard.svg" class="mw-100 mh-100" />
													</div>
													<div class="ml-3 flex-grow-1">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="width-40 height-40 rounded">
														<img src="<?php echo base_url(); ?>assets/studio/img/icon/visa.svg" class="mw-100 mh-100" />
													</div>
													<div class="ml-3 flex-grow-1">
