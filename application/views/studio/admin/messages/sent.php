...
<div id="content" class="app-content p-0">
			...
			<div class="mailbox">
				...
				<div class="mailbox-toolbar">
					...
					<div class="mailbox-toolbar-item"><a href="#" class="mailbox-toolbar-link active">Sent</a></div>
					<div class="mailbox-toolbar-item"><a href="<?php echo site_url('admin/messages/compose'); ?>" class="mailbox-toolbar-link text-primary bg-blue-transparent-1">New Message <i class="fa fa-pen fs-12px ml-1"></i></a></div>
				</div>
				<!-- END mailbox-toolbar -->
				<!-- BEGIN mailbox-body -->
							...
							<div class="mailbox-list">
								...
								<div class="mailbox-list-item">
									<div class="mailbox-message">
										<a href="<?php echo site_url('admin/messages/view/'.$message['id']); ?>" class="mailbox-list-item-link">
