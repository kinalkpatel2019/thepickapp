			...
			<div class="menu">
				...
				<div class="menu-item dropdown">
					<a href="#" data-toggle="dropdown" data-display="static" class="menu-link">
						...
						<div class="menu-text"><?php echo $vendor['firstname'];?>&nbsp;<?php echo $vendor['lastname']; ?></div>
					</a>
					<div class="dropdown-menu dropdown-menu-right mr-lg-3">
						<a class="dropdown-item d-flex align-items-center" href="<?php echo site_url('vendor/profile'); ?>">Edit Profile <i class="fa fa-user-circle fa-fw ml-auto text-gray-400 f-s-16"></i></a>
						<a class="dropdown-item d-flex align-items-center" href="<?php echo site_url('vendor/profile/settings'); ?>">Setting <i class="fa fa-wrench fa-fw ml-auto text-gray-400 f-s-16"></i></a>
