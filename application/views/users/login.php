      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="p-5">
            ...
            <form class="user" name="frmlogin" id="frmlogin" action="<?php echo site_url('users/authenticate'); ?>" method="post">
            ...
            <div class="text-center">
              <a class="small" href="<?php echo site_url('users/register'); ?>">Create an Account!</a>
            </div>
          </div>
        </div>
      </div>
